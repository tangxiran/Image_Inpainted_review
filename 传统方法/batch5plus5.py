...
def get_importance(little_batch,picture_array, flag_point , believe_importance_ndarray):
    # believe_ndarray 代表
...
if __name__ == '__main__':
    file  = '../thin_finger.png'
    mask = '../mask.png'
    pic_after_inpainted_save_dir = 'thin_afterInpainted//'
    makedir(pic_after_inpainted_save_dir)
    pic_to_inpainted_origin = cv2.imread(filename=file,flags=0)
