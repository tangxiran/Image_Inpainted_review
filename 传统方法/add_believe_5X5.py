...
if __name__ == '__main__':
    ...
    for pic_one in file_list:
        ...
        for importace_number in range(100,10000+1,1000):

            pic_after_inpainted_save_dir = 'origin_finger_batchInpainted//importanceX'+str(importace_number)+'_'+ pic_one.replace('.png','')+'//'
            ...
            # 、增加一个置信度矩阵，设置靠近中心的为0 ，最外端为1，越往里的修复结果 置信度越小
